...
<header>
	    	...
	    	<ul class="sf-menu" id="menu"><li><a href="ajax/search-form.php" data-target="#contact" id="contactus" data-toggle="modal1">search</a></li></ul>
				</nav>
				</div>
			</div>
		</div>
    ...
    <div class="noPadding center container-fluid">
      <div class="bg" style="min-height:550px;">
        <div class="topBannerHome">
          ...
          <h1 class="pageTitle"  >Ahlia ITMS 523 Project</h1>
          <h2 class="pageSubtitle"  >Download youtube video ;)</h2>
        </div>
...
<form onsubmit="youtube()" id="downloadForm" class="search-form" method="POST" action="javascript:void(0);">
                            <input name="video_url" id="video_url" class="url-input" type="text" placeholder= "Enter the video link here"  />
